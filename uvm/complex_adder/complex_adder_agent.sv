class complex_agent extends uvm_agent;

    `uvm_component_utils(complex_agent)

    //--------------------------------------------
    // Components
    //--------------------------------------------

    complex_driver driver;
    complex_monitor monitor;
    uvm_sequencer #(complex_transaction) sequencer;
